...
@Service //z teto anotace plyne, ze instance se vytvori jenom jedna a bude jen jeden seznam
public class VizitkaService {
    private final List<Vizitka> seznamVizitek = new ArrayList<>();

    public void add(Vizitka vizitka) {  //metoda pro PostMapping na pridani nove vizitky do seznamu
    ...
    public Vizitka deleteById(int id) {
        return seznamVizitek.remove(id);
    }
}